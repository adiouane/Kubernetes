...
echo "Starting GitLab cleanup process..."

# Delete Helm release
echo "Deleting GitLab Helm release..."
helm uninstall gitlab -n gitlab

# Wait for pods deletion
echo "Waiting for pods to be deleted..."
kubectl wait --for=delete pods --all -n gitlab --timeout=300s

# Delete namespace
echo "Deleting gitlab namespace..."
kubectl delete namespace gitlab --timeout=300s

# Delete any leftover PVs and PVCs
echo "Deleting persistent volumes and claims..."
kubectl delete pv,pvc -l release=gitlab --force --grace-period=0
...
# Remove local directories (adjust paths as needed)
...
echo "Cleanup completed!"echo "Starting GitLab cleanup process..."
